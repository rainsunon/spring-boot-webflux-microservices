...
import mitrasoft.ru.auth.exception.error.ApiError;
import mitrasoft.ru.auth.exception.error.NotFoundError;
import mitrasoft.ru.auth.exception.error.SimpleApiError;
